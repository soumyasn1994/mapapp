package com.example.nandhu.mapapp;
...
import com.example.nandhu.mapapp.POJO.Example;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        /*mMap.setOnMyLocationChangeListener(new GoogleMap.OnMyLocationChangeListener() {
            ...
            public void onMyLocationChange(Location arg0) {
                ...
                Model_Town = new LatLng(arg0.getLatitude(), arg0.getLongitude());

            }
        });*/
        Model_Town = new LatLng(28.7158727, 77.1910738);
        mMap.addMarker(new MarkerOptions().position(Model_Town).title("Marker in India"));
